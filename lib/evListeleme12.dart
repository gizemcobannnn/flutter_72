...
class evListeleme12 extends StatelessWidget {
  evListeleme12({
    key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(startFraction: 0.0603, endFraction: 0.5918),
            Pin(size: 14.0, middle: 0.2016),
            child: Text(
              'Tatlı Listeleme Ekranı',
              style: TextStyle(
          ...
          Pinned.fromPins(
            Pin(size: 102.0, start: 56.8),
            Pin(size: 49.0, middle: 0.5055),
            child: Text(
              'Ürün Açıklaması\n\n',
              style: TextStyle(
                fontFamily: 'Metropolis',
          ...
          Pinned.fromPins(
            Pin(size: 146.0, start: 56.8),
            Pin(size: 14.0, middle: 0.5757),
            child: Text(
              'Yemek Kategorisi : Tatlı',
              style: TextStyle(
                fontFamily: 'Metropolis',
                fontSize: 14,
                color: const Color(0xffb6b7b7),
          ...
          Pinned.fromPins(
            Pin(size: 94.0, start: 56.8),
            Pin(size: 15.0, middle: 0.6687),
            child: Text(
              'Ürün Görselleri',
              style: TextStyle(
                fontFamily: 'Metropolis',
          ...
          Pinned.fromPins(
            Pin(size: 29.0, end: 46.3),
            Pin(size: 29.0, middle: 0.6715),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/kamera.png'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
