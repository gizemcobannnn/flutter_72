    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.063, -0.257),
            child: PageLink(
              links: [
                PageLinkInfo(
          ...
          Align(
            alignment: Alignment(-0.648, -0.266),
            child: Container(
              width: 36.0,
              height: 36.0,
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 154.0, end: 18.5),
            Pin(size: 195.0, middle: 0.7086),
            child: SvgPicture.string(
              _svg_ai6h1,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 99.0, start: 48.5),
            Pin(size: 17.0, middle: 0.7085),
            child: Text(
              'Fatmanur Aydın',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Align(
            alignment: Alignment(-0.55, 0.259),
            child: Container(
              width: 80.0,
              height: 80.0,
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 80.0, end: 53.5),
            Pin(size: 80.0, middle: 0.6219),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
          ...
          Align(
            alignment: Alignment(0.573, 0.464),
            child: SizedBox(
              width: 81.0,
              height: 40.0,
          ...
          Pinned.fromPins(
            Pin(size: 84.0, start: 49.0),
            Pin(size: 23.0, middle: 0.7469),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
...
const String _svg_smfqt1 =
    '<svg viewBox="380.0 88.0 5.0 5.0" ><path transform="translate(380.03, 88.01)" d="M 0 0 L 4.983489990234375 4.983489990234375" fill="none" stroke="#19d5ff" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_qam8 =
    '<svg viewBox="385.0 88.0 5.0 5.0" ><path transform="translate(385.02, 88.01)" d="M 4.983489990234375 0 L 0 4.983489990234375" fill="none" stroke="#19d5ff" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_ai6h1 =
    '<svg viewBox="238.5 379.8 154.0 195.0" ><path transform="translate(238.5, 379.83)" d="M 27 0 L 127 0 C 141.9116821289062 0 154 12.08831119537354 154 27 L 154 168 C 154 182.9116821289062 141.9116821289062 195 127 195 L 27 195 C 12.08831119537354 195 0 182.9116821289062 0 168 L 0 27 C 0 12.08831119537354 12.08831119537354 0 27 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_numxwt =
    '<svg viewBox="27.5 379.8 173.0 211.0" ><defs><linearGradient id="gradient" x1="0.923415" y1="0.088314" x2="0.089101" y2="0.989925"><stop offset="0.0" stop-color="#00dcff" /><stop offset="1.0" stop-color="#67b3ff" stop-opacity="0.77"/></linearGradient></defs><path transform="translate(27.5, 379.83)" d="M 34 0 L 139 0 C 157.7776794433594 0 173 15.22231674194336 173 34 L 173 177 C 173 195.7776794433594 157.7776794433594 211 139 211 L 34 211 C 15.22231674194336 211 0 195.7776794433594 0 177 L 0 34 C 0 15.22231674194336 15.22231674194336 0 34 0 Z" fill="url(#gradient)" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
