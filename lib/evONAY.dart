...
class evONAY extends StatelessWidget {
  evONAY({
    key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 15.0, middle: 0.4279),
            Pin(size: 11.0, start: 31.0),
            child: Text(
              '4.9',
              style: TextStyle(
                fontFamily: 'Metropolis',
          ...
          Pinned.fromPins(
            Pin(size: 2.0, middle: 0.5023),
            Pin(size: 2.0, start: 57.0),
            child: Container(
              decoration: BoxDecoration(
          ...
          Align(
            alignment: Alignment(0.003, 0.53),
            child: SizedBox(
              width: 80.0,
              height: 16.0,
              child: Text(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 446.0, middle: 0.3958),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xffffffff),
                borderRadius: BorderRadius.circular(36.0),
                border: Border.all(width: 0.5, color: const Color(0xff19d5ff)),
                boxShadow: [
                  BoxShadow(
                    color: const Color(0x29000000),
                    offset: Offset(0, 3),
          ...
          Pinned.fromPins(
            Pin(size: 74.0, middle: 0.4925),
            Pin(size: 74.0, end: 55.2),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
          ...
          Align(
            alignment: Alignment(-0.023, -0.36),
            child: SizedBox(
              width: 32.0,
              height: 24.0,
              child: SvgPicture.string(
              ...
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(6.0),
                    border:
                        Border.all(width: 1.0, color: const Color(0xfb19d5ff)),
                  ),
                ),
                Align(
                  alignment: Alignment(-0.015, -0.267),
                  child: SizedBox(
                    width: 154.0,
                    height: 20.0,
                    child: Text(
                ...
                Pinned.fromPins(
                  Pin(size: 298.0, start: 21.0),
                  Pin(size: 38.0, middle: 0.5),
                  child: Text(
                    'Siparişiniz aşçımızla anlaştığınız sürede\nsize en iyi şekilde teslim edilecektir.',
                    style: TextStyle(
                      fontFamily: 'SF Pro Display',
                      fontSize: 16,
                      color: const Color(0xad333333),
                      letterSpacing: 0.0,
                      fontWeight: FontWeight.w600,
                      height: 1.375,
                    ),
                ...
                Align(
                  alignment: Alignment(-0.01, 0.592),
                  child: SizedBox(
                    width: 54.0,
                    height: 16.0,
                    child: Text(
...
const String _svg_ugdtyv =
    '<svg viewBox="185.1 227.5 32.1 23.5" ><path transform="translate(185.08, 159.52)" d="M 31.5970344543457 68.46713256835938 C 30.97091102600098 67.84095001220703 29.95579147338867 67.84095001220703 29.32954025268555 68.46713256835938 L 10.12033748626709 87.67652893066406 L 2.736635446548462 80.29282379150391 C 2.110512733459473 79.66664123535156 1.095388293266296 79.66670227050781 0.4691402614116669 80.29282379150391 C -0.1570451408624649 80.9189453125 -0.1570451408624649 81.93407440185547 0.4691402614116669 82.56025695800781 L 8.986590385437012 91.07757568359375 C 9.612525939941406 91.70371246337891 10.62839984893799 91.70326995849609 11.25408554077148 91.07757568359375 L 31.5970344543457 70.73464202880859 C 32.22321701049805 70.10850524902344 32.22315979003906 69.09333038330078 31.5970344543457 68.46713256835938 Z" fill="#ffffff" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
