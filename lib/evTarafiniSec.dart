    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                  ...
                  children: <Widget>[
                    Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromPins(
                          Pin(start: 5.3, end: 18.7),
                          Pin(size: 138.0, end: 20.5),
                          child: Container(
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image:
                                    const AssetImage('assets/images/asci.png'),
                                fit: BoxFit.fill,
                              ),
                            ),
                          ),
                        ...
                        Pinned.fromPins(
                          Pin(start: 15.7, end: 16.3),
                          Pin(size: 43.0, start: 17.8),
                          child: Text(
                            'Pişiren Ol',
                            style: TextStyle(
                              fontFamily: 'Poppins',
          ...
          Align(
            alignment: Alignment(-0.01, 0.203),
            child: SizedBox(
              width: 139.0,
              height: 43.0,
              child: Text(
